...
function love.draw()
	if (ll_game_scene == "title") then
		...
		love.graphics.draw(ll_image_title["background"], 0, 0);
	end
end
...
function love.load()
	...
	love.window.setTitle("Long life v.0.0.0000")

	ll_image_title["background"] = love.graphics.newImage("res/backgrounds/title.png")
